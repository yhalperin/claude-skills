...
```jsonc
{
  ...
  "initiatives": {
    "jag-36913": {                               // key: lowercased initiative issue key - drives dropdown value + localStorage risk scoping
      ...
      "horizon": "Target TBD",                     // free text horizon badge, e.g. "Target Oct 2026" or "TBD"
      "timelineRange": "TBD",                       // free text, e.g. "Jul 2026 - Oct 2026" or "TBD"
      "stats": {
        "totalFeatures": 13,                        // count of all leaf features across all master features
        "completedFeatures": 4,                      // count of leaf features with status "Completed"
        "timelineTarget": "TBD",                      // target end date if known, else "TBD"
      ...
      "masterFeatures": [
        {
          ...
          "progress": 57,                                // round(average of this master feature's features[].progress)
          "targetDate": "TBD",                            // duedate formatted "MMM DD, YYYY", else "TBD"
          "features": [
            {
              ...
              "date": "TBD"                                       // duedate formatted "MMM DD", else "TBD"
            }
          ]
        }
      ]
